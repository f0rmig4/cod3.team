          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            >
              ...
              <blockquote className="text-lg text-gray-400 grow">
                — Cod3.team has helped us in developing an application
                customized to our needs, with many tools that were not available
                in expensive commercial products, increasing the productivity of
                our staff.
              </blockquote>
