        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <Link
                  href="mailto:cod3.team@proton.me"
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M26 25H6a3 3 0 0 1-3-3V10a3 3 0 0 1 3-3h20a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3zM6 9a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h20a1 1 0 0 0 1-1V10a1 1 0 0 0-1-1H6z" />
                    <path d="m26.2 10-8.9 6.2a2 2 0 0 1-2.6 0L5.8 10h20.4z" />
                  </svg>
                </Link>
              </li>
              <li className="ml-4">
                <Link
                  href="https://github.com/cod3t3am"
                  className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out"
                  aria-label="Github"
                  target="_blank"
